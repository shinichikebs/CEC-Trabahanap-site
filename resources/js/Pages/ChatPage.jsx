...
export default function ChatPage({ contactUser, currentUserId }) {
    ...
    // Polling to fetch the latest messages periodically
    useEffect(() => {
        const interval = setInterval(async () => {
            try {
                ...
                console.error("Error fetching messages via polling:", error);
            }
        ...
        <div className="flex flex-col h-screen bg-gray-100">
            ...
            <header className="bg-[#231955] text-white py-4 px-6 shadow flex items-center justify-between">
                ...
                <button
                    ...
                    className="text-[#E8AA42] bg-transparent border border-[#E8AA42] justify-end item-end rounded-lg py-2 px-4 hover:bg-[#D18C33] hover:text-white transition duration-200"
                >
                    <IoMdArrowBack />
                </button>
            </header>
